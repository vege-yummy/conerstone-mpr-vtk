...
var JpegImage = (function jpegImage () {
  ...
  function buildHuffmanTable (codeLengths, values) {
    var k = 0; var code = []; var i; var j; var length = 16
  ...
  function decodeScan (data, offset,
    ...
    var maxH = frame.maxH; var maxV = frame.maxV

    var startOffset = offset; var bitsData = 0; var bitsCount = 0
    ...
    function decodeACFirst (component, offset) {
      ...
      var k = spectralStart; var e = spectralEnd
      while (k <= e) {
        var rs = decodeHuffman(component.huffmanTableAC)
        var s = rs & 15; var r = rs >> 4
        if (s === 0) {
    ...
    var successiveACState = 0; var successiveACNextValue
    function decodeACSuccessive (component, offset) {
      var k = spectralStart; var e = spectralEnd; var r = 0
      while (k <= e) {
        var z = dctZigZag[k]
  ...
  constructor.prototype = {
    ...
    parse: function parse (data) {
      ...
      var offset = 0; var length = data.length
      var jfif = null
      var adobe = null
      var pixels = null
      var frame, resetInterval
      var quantizationTables = []
      var huffmanTablesAC = []; var huffmanTablesDC = []
      ...
      while (fileMarker != 0xFFD9) { // EOI (End of image)
        ...
        switch (fileMarker) {
          ...
          case 0xFFC2: // SOF2 (Start of Frame, Progressive DCT)
            ...
            frame.components = []
            frame.componentIds = {}
            var componentsCount = data[offset++]; var componentId
            var maxH = 0; var maxV = 0
    ...
    getData16: function getData16 (width, height) {
      ...
      var scaleX = this.width / width; var scaleY = this.height / height
      ...
      for (i = 0; i < numComponents; i++) {
        ...
        var j; var k; var ll = 0
        var lineOffset = 0
        for (var blockRow = 0; blockRow < blocksPerColumn; blockRow++) {
          var scanLine = blockRow << 3
          for (var blockCol = 0; blockCol < blocksPerLine; blockCol++) {
            var bufferOffset = getBlockBufferOffset(component, blockRow, blockCol)
            var offset = 0; var sample = blockCol << 3
            for (j = 0; j < 8; j++) {
